...
| | |
| --- | --- |
| **Deep reference (all topics)** | `AI_System_Engineer_Learning_Track_2027_REFERENCE.md` |
| **Strategy & capstone** | `AI_System_Engineer_plan_2027.md` |
...
*Granular topics:* Reference → **Course 0**
...
*Granular topics & CampusX:* Reference → **Course 1**
...
*Code labs & CampusX:* Reference → **Course 2**
...
*Parsing deep dive:* Reference → **Course 5**
...
*Hub:* [graphiti-mcp](https://github.com/patchy631/ai-engineering-hub/tree/main/graphiti-mcp) · Reference → **Course 6**
...
*CI patterns:* Reference → **Course 8**
...
*OPA & observability depth:* Reference → **Course 9**
...
*Capstone architecture & hub labs:* Reference → **Course 10** · Plan → **§13**
...
*Deploy checklist:* Reference → **Course 11**
...
*Frontier catalog:* Plan §7 · Reference → **Course 13**
...
*Interview question bank:* Reference → **Course 15**
...
| Need | File |
| --- | --- |
| Topic-by-topic depth, interview prompts, pitfalls | `AI_System_Engineer_Learning_Track_2027_REFERENCE.md` |
| CampusX, Hub index, quarterly reads, link log | Reference appendices A–F |
| Market, ethics, capstone prose, resume | `AI_System_Engineer_plan_2027.md` |
